...
//
// 'GameScene' is responsible for diplaying everything for Swiftris - it will render
// the tetrominos on screen, the background, and the game board. Furthermore,
// 'GameScene' will be responsible for playing the sounds and keeping track of
// the time.
//
// 'A Ticking Clock'
//
// NOTES:
// SpriteKit is based on OpenGL and therefore its coordinate system is opposite
// to iOS' native cocoa coordinates. 0, 0 in SpriteKit is the bottom-left corner.
// Swiftris will be drawn from the top down so therefore we anchor our game in
// the top-left corner of the screen: 0, 1.0. We then create an SKSpriteNode
...
let TickLengthLevelOne = NSTimeInterval(600)    // (1)
